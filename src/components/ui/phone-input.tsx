    ...
    ({ className, onChange, ...props }, ref) => {
      ...
      return (
        <RPNInput.default
          ...
          smartCaret={false}
          labels={locale === 'fr' ? frLocale : undefined}
          /**
  ...
  return (
    <Popover>
      ...
      <PopoverContent className="w-[300px] p-0">
        <Command>
          <CommandInput
            placeholder={t('components.phoneInput.searchCountry')}
          />
          <CommandList>
            <ScrollArea className="h-72">
              <CommandEmpty>
                {t('components.phoneInput.noCountryFound')}
              </CommandEmpty>
              <CommandGroup>
  ...
  return (
    <CommandItem className="gap-2" onSelect={() => onChange(country)}>
      ...
      <span className="text-foreground/50 text-sm">
        {t('components.phoneInput.countryCode', {
          code: countryCode,
        })}
      </span>
      <CheckIcon
